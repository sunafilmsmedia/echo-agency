...
function lookupCode(code: string): PortalData | null {
  ...
  if (code.toUpperCase() === "DEMO01") {
    return {
      ...
      brandGuideUrl: "https://sunafilmsmedia.com/personalbrand",
...
function PortalView({ session, onLogout }: { session: PortalData; onLogout: () => void }) {
  const { clientId, clientName, monthlyFee, monthlyViews, costPerLead, driveUrl, scriptGptUrl, brandGuideUrl, agencyName, agencyColor } = session;
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-8 space-y-6">
        ...
        {/* Drive + Script GPT + Brand guide — 3-column on desktop */}
